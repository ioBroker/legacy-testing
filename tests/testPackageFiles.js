...
describe('Test package.json and io-package.json', () => {
    it('Test package files', done => {
        ...
        const fileContentIOPackage = readFileSync(`${adapterDir}/io-package.json`, 'utf8');
        ...
        const licenseFileExists = existsSync(`${adapterDir}/LICENSE`);
        const fileContentReadme = existsSync(`${alternativeAdapterDir}/README.md`)
            ? readFileSync(`${alternativeAdapterDir}/README.md`, 'utf8')
            : readFileSync(`${adapterDir}/README.md`, 'utf8');
